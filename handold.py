...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 hand_maskrcnn.py train --dataset=/path/to/hand/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 hand_maskrcnn.py train --dataset=/path/to/hand/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 hand_maskrcnn.py train --dataset=/path/to/hand/dataset --weights=imagenet

    # Apply color splash to an image
    python3 hand_maskrcnn.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 hand_maskrcnn.py splash --weights=last --video=<URL or path to file>
"""
import os
import sys
import json
...
# Import Mask RCNN
sys.path.append(ROOT_DIR)  # To find local version of the library 添加引用目录
