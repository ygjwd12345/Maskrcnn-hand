...
COCO_WEIGHTS_PATH="/media/ygl/深度学习/myjupyter/Mask_RCNN/Mask_RCNN/samples/hand/mask_rcnn_coco.h5"
# Directory to save logs and model checkpoints, if not provided
# through the command line argument --logs
#DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs")
DEFAULT_LOGS_DIR="/media/ygl/深度学习/myjupyter/Mask_RCNN/Mask_RCNN/samples/hand/logs"
############################################################
#  Configurations
############################################################
...
class HandDataset(utils.Dataset):
    ...
    def load_hand(self, dataset_dir, subset):
        ...
        for i in range(1,count_img):
            path=os.path.join(dataset_dir, subset)
            path=path+str(i)+'.json'
            #annotations = json.load(open(os.path.join(dataset_dir, "via_region_data.json"))) old
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/media/ygl/深度学习/myjupyter/Mask_RCNN/Mask_RCNN/samples/hand/datasets/",
                        help='Directory of the hand dataset')
    parser.add_argument('--weights', required=True,
                        metavar="/media/ygl/深度学习/myjupyter/Mask_RCNN/Mask_RCNN/samples/hand/mask_rcnn_coco.h5",
